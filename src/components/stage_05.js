...
export default function Stage_05(props) {
  ...
  return (
    <div className="stage-container">
      ...
      {tip === 1 && <TextModal text={"ORDER"} setTip={setTip} />}
      {tip === 2 && <EmojiModal emoji={'🔥'} setTip={setTip} />}
      {tip === 3 && <TextModal text={"Q _ _ _ _ _ _"} setTip={setTip} />}
