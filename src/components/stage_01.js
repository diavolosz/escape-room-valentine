...
export default function Stage_01(props) {
  ...
  return (
    <div className="stage-container">
      ...
      {tip === 1 && <EmojiModal emoji={'💖'} setTip={setTip} />}
      {tip === 2 && <TextModal text={"COLOUR NUMER"} setTip={setTip} />}
      {tip === 3 && <TextModal text={"5 _ _ _ _"} setTip={setTip} />}
    </div> 
  )
}